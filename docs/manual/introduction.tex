...
\item
  ...
  \\
  %END LATEX
  \url{https://checkerframework.org/checker-framework-3.5.0.zip}
...
of a checker, separated by an underscore ``\<\_>''.
...
\end{Verbatim}
\noindent to pass different lint options to the Nullness and GUI Effect Checkers.
